package bg.softuni.webbookstore.constant;
...
public class GlobalConstants {
    ...
    public static final String EMPTY_ORDER_ERROR_MESSAGE =
            "We are really sorry, the selected books are no longer available for purchase. You can browse the books on our homepage.";
